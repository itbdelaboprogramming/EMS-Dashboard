                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="progress2 progress-moved">
                                    <div class="progress-bar2" style="width:<?php echo $progress_bar_1 ?>%;">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="progress2 progress-moved">
                                    <div class="progress-bar2" style="width:<?php echo $progress_bar_2 ?>%;">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="progress2 progress-moved">
                                    <div class="progress-bar2" style="width:<?php echo $progress_bar_3 ?>%;">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="progress2 progress-moved">
                                    <div class="progress-bar2" style="width:<?php echo $progress_bar_4 ?>%;">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="progress2 progress-moved">
                                    <div class="progress-bar2" style="width:<?php echo $progress_bar_5 ?>%;">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="progress2 progress-moved">
                                    <div class="progress-bar2" style="width:<?php echo $progress_bar_6 ?>%;">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="progress2 progress-moved">
                                    <div class="progress-bar2" style="width:<?php echo $progress_bar_7 ?>%;">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="progress2 progress-moved">
                                    <div class="progress-bar2" style="width:<?php echo $progress_bar_8 ?>%;">
                                    </div>
                                </div>
                            </td>
                            <td>
