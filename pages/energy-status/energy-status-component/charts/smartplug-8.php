...
$current  = mysqli_query($connect, 'SELECT current FROM tuya_smart_plug_8 WHERE current IS NOT NULL ORDER BY id DESC LIMIT 20');
$power  = mysqli_query($connect, 'SELECT power FROM tuya_smart_plug_8 WHERE power IS NOT NULL ORDER BY id DESC LIMIT 20');
$electricity  = mysqli_query($connect, 'SELECT electricity FROM tuya_smart_plug_8 WHERE electricity IS NOT NULL ORDER BY id DESC LIMIT 20');
