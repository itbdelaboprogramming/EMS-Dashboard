...
Device_Id = 'eb66812c3c84023d01haln' # Device Id from Tuya device sensor
Address_Id = '192.168.18.16' # IP Address connected to Tuya device sensor
Local_Key = '5e2b12822974c2a0' # Local Key generated from  python -m tinytuya wizard
...
while True:
    try:
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_3`(time, voltage, current, power, electricity, day, week, month) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
        ...
        sum_power = "SElECT SUM(electricity) FROM `tuya_smart_plug_3`"
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_3`(total_electricity, total_cost, carbon_emission) VALUES (%s,%s,%s)"
