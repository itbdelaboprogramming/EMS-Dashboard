...
Device_Id = 'eb69bfa321e8bbfc08wium' # Device Id from Tuya device sensor
Address_Id = '192.168.18.12' # IP Address connected to Tuya device sensor
Local_Key = '9a1ae2e03a35cdd8' # Local Key generated from  python -m tinytuya wizard
...
while True:
    try:
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_7`(time, voltage, current, power, electricity, day, week, month) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
        ...
        sum_power = "SElECT SUM(electricity) FROM `tuya_smart_plug_7`"
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_7`(total_electricity, total_cost, carbon_emission) VALUES (%s,%s,%s)"
