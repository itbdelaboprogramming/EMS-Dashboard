...
while True:
    try:
        ...
        timer_initial = datetime.datetime(2022, 8, 25, 15, 40)
        # print(timer_initial)
        ...
        # Database Connection
        db = pymysql.connect(host='192.168.18.53',
                             user='admin',
                             password='admin',
                             db='monitoring',
                             charset='utf8',
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_9`(time, voltage, current, power, electricity, day, week, month) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
        ...
        sum_power = "SElECT SUM(electricity) FROM `tuya_smart_plug_9` GROUP BY DATE(time)"
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_9`(total_electricity, total_cost, carbon_emission) VALUES (%s,%s,%s)"
