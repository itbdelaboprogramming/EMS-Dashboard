...
Device_Id = 'eb9b8a4dc0aaef8ec5sqkk' # Device Id from Tuya device sensor
Address_Id = '192.168.18.20' # IP Address connected to Tuya device sensor
Local_Key = '5f5bc68dac1d936f' # Local Key generated from  python -m tinytuya wizard
...
while True:
    try:
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_2`(time, voltage, current, power, electricity, day, week, month) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
        ...
        sum_power = "SElECT SUM(electricity) FROM `tuya_smart_plug_2`"
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_2`(total_electricity, total_cost, carbon_emission) VALUES (%s,%s,%s)"
