...
Device_Id = 'eb011a012de1685d0bfhih' # Device Id from Tuya device sensor
Address_Id = '192.168.18.13' # IP Address connected to Tuya device sensor
Local_Key = 'a61ff6d89e1ed9b6' # Local Key generated from  python -m tinytuya wizard
...
while True:
    try:
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_1`(time, voltage, current, power, electricity, day, week, month) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
        ...
        sum_power = "SElECT SUM(electricity) FROM `tuya_smart_plug_1`"
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug_1`(total_electricity, total_cost, carbon_emission) VALUES (%s,%s,%s)"
