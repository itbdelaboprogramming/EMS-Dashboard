...
# Local Key generated from  python -m tinytuya wizard
Local_Key = 'ffd23b959050c09a'
...
while True:
    ...
    if status == "online":
        ...
        try:
            ...
            if current == 0:
                print("SSSS")
                query = "INSERT INTO `tuya_smart_plug_5` (time, voltage, current, power, electricity, day, week, month, total_electricity, total_cost, carbon_emission) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
