...
while True:
    try:
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug`(time, voltage, current, power, electricity, day, week, month) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
        ...
        sum_power = "SElECT SUM(electricity) FROM `tuya_smart_plug` GROUP BY DATE(time)"
        ...
        add_c0 = "INSERT INTO `tuya_smart_plug`(total_electricity, total_cost, carbon_emission) VALUES (%s,%s,%s)"
